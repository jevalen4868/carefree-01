...
//  @Test
//  public void getOne() {
//    Spittle thirteen = spittleRepository.getOne(13);
...
//  public void save() {
//    assertEquals(15, spittleRepository.count());
//    Spitter spitter = spittleRepository.getOne(13).getSpitter();
...
//    assertNewSpittle(spittleRepository.getOne(16L));
//  }
//
//  @Test
//  @Transactional
//  public void delete() {
//    assertEquals(15, spittleRepository.count());
//    assertNotNull(spittleRepository.getOne(13));
//    spittleRepository.delete(13L);
//    assertEquals(14, spittleRepository.count());
//    assertNull(spittleRepository.getOne(13));
//  }
//
