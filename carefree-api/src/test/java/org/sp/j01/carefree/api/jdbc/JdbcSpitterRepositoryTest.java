...
//  @Transactional
//  public void getAll() {
//    List<Spitter> spitters = spitterRepository.getAll();
...
//  @Transactional
//  public void getOne() {
//    assertSpitter(0, spitterRepository.getOne(1L));
//    assertSpitter(1, spitterRepository.getOne(2L));
//    assertSpitter(2, spitterRepository.getOne(3L));
//    assertSpitter(3, spitterRepository.getOne(4L));
//  }
//
//  @Test
//  @Transactional
...
//    assertSpitter(4, spitterRepository.getOne(5L));
//  }
//
//  @Test
//  @Transactional
...
//    assertEquals(4, spitterRepository.count());
//    Spitter updated = spitterRepository.getOne(4L);
